...
function WaitingForDriver(props) {
  return (
    ...
    <div>
        <h5 onClick={() => { props.setWaitingForDriver(false)  }}  className="p-1 text-center absolute top-0  w-[93%] flex justify-center items-center"><FaChevronDown className="text-gray-500"/></h5>
